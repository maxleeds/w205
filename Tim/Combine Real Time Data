...
LEFT JOIN combinedstopsdata ON trip_update_day.trip_id = combinedstopsdata.trip_id
...
real_time_trip_schedule.route_id,
real_time_trip_schedule.stop_id,
real_time_trip_schedule.arrival_delay,
real_time_trip_schedule.arrival_time_update,
real_time_trip_schedule.departure_delay,
real_time_trip_schedule.departure_time_update,
real_time_trip_schedule.week_day_num,
real_time_trip_schedule.arrival_time,
real_time_trip_schedule.departure_time,
real_time_trip_schedule.arrival_time_unix,
real_time_trip_schedule.departure_time_unix,
real_time_trip_schedule.stop_name,
real_time_trip_schedule.stop_latitude,
real_time_trip_schedule.stop_longitude,
real_time_trip_schedule.stop_sequence,
real_time_trip_schedule.departure_schedule_delay,
real_time_trip_schedule.arrival_schedule_delay,
vehicle_position_day.timestamp,
