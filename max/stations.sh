...
sudo -u hdfs dfs -mkdir /user/w205/mtastatic
...
sudo -u hdfs dfs -mkdir /user/w205/mtastatic/stations
sudo -u hdfs dfs -put stationsfinal.csv /user/w205/mtastatic/stations
...
sudo -u hdfs dfs -mkdir /user/w205/mtastatic/complexes
sudo -u hdfs dfs -put complexesfinal.csv /user/w205/mtastatic/complexes
